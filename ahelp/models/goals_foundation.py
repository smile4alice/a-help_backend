...
class GoalsFoundationModel(db.Model):
    """Basic model of data for the goals of the charitable foundation"""

    __tablename__ = "Goals of the foundation"

    id: int = db.Column(db.Integer, primary_key=True, autoincrement=True)
    photo_path: str = db.Column(db.String)
    title: str = db.Column(db.String(100), nullable=False)
    title_en: str = db.Column(db.String(100), nullable=False)
    description: str = db.Column(db.String(600), nullable=False)
    description_en: str = db.Column(db.String(600), nullable=False)
